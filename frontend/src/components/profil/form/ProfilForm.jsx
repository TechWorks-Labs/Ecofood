    ...
    return (
        <form className="w-full flex flex-col justify-around items-center p-3 mt-10">
            <div className="w-full flex flex-col gap-y-2 items-center">
                <div className="w-full flex flex-col gap-x-3 gap-y-2 sm:flex sm:flex-row sm:items-center sm:gap-y-0">
                    <span>Civilité *</span>
                    <div className="flex flex-row gap-x-5 items-center">
                        <input
                            className="formProfil-input"
                            type="radio"
                            name='civility'
                            value="madame"
            ...
            <div className="w-full flex flex-col gap-y-5 sm:flex sm:flex-row sm:justify-between sm:items-center p-3">
                ...
                <div className="flex flex-row justify-center items-center gap-x-2">
                    ...
                    <button type='submit' onClick={props.handleSubmit} className="w-full p-4 h-[45px] mt-3 sm:mt-0 sm:w-[90px] sm:h-[35px] flex justify-center items-center bg-white p-1 rounded-md text-slate-800  border border-1 border-slate-400 font-medium hover:duration-300 hover:bg-slate-800 hover:text-white">Suivant</button>
                </div>
